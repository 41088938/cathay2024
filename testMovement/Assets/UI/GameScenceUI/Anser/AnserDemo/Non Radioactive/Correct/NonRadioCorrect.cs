...
public class NonRadioCorrect : MonoBehaviour
{
   ...
   /* private void Start()
    ...
    public GameObject GetAnserNonRadioCorr(int x)
        {
            switch (x)
            {
            case 1:
            ...
            case 17:
                return anser[16];
                break;
            case 20: return posAnser[0];
                    break;
            case 21: return posAnser[1];
                    break;
            case 22: return posAnser[2];
                    break;
            case 23: return posAnser[3];
                     break;
            case 24:
                return posAnser[4];
                break;
        ...
        public int GetNonRadioCorrOfftotalCorrectanser()
        {
